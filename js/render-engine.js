...
class Renderer {
    ...
    flagFlash() {
        tl.set(flagFlash, { display: "block" })
            .to(flagFlash, { duration: 0.3, opacity: 0.7 })
    ...
    revealMole(id) {
        document.getElementById(id).style.backgroundImage =
            "image-set(url('../img/mole/mole.webp') 1x, url('../img/mole/mole@2x.webp') 2x, url('../img/mole/mole@3x.webp') 3x)";
    ...
    endGame(gameWon) {
        if (gameWon) {
            ...
            endgameImg.srcset =
                "img/sleeping-mole/sleeping-mole.webp, img/sleeping-mole/sleeping-mole@2x.webp 2x, img/sleeping-mole/sleeping-mole@3x.webp 3x";
            ...
            endgameImg.srcset =
                "img/angry-mole/angry-mole.webp, img/angry-mole/angry-mole@2x.webp 2x, img/angry-mole/angry-mole@3x.webp 3x";
            endgameText.innerHTML =
...
export class RenderEngine extends Renderer {
    ...
    startViz() {
        gsap.set([introLogo, playBtn, startDialogue], {
            visibility: "visible",
        });
        gsap.from(introLogo, {
            duration: 1,
